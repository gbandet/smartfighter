    ...
    public static class HookDB {
        public static Dictionary<string, HookEntry> hooks = new Dictionary<string, HookEntry> {
            ...
            { "selectMenu", new HookEntry(
                 ...
                 new byte[32] { 0x48, 0x89, 0x5C, 0x24, 0x08, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xF9, 0xE8, 0xDE, 0xCD,
                                0xCD, 0xFF, 0x48, 0x8D, 0x97, 0x70, 0x04, 0x00, 0x00, 0x48, 0x8B, 0xC8, 0xE8, 0xFF, 0xEA, 0xCE })
            },
