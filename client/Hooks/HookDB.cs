    ...
    public static class HookDB {
        public static Dictionary<string, HookEntry> hooks = new Dictionary<string, HookEntry> {
            ...
            {"setRoundStats", new HookEntry(
                ...
                new byte[32] { 0x48, 0x89, 0x5C, 0x24, 0x10, 0x48, 0x89, 0x6C, 0x24, 0x18, 0x48, 0x89, 0x74, 0x24, 0x20, 0x57,
                               0x41, 0x56, 0x41, 0x57, 0x48, 0x83, 0xEC, 0x40, 0x4C, 0x8B, 0xF1, 0xC7, 0x81, 0x18, 0x01, 0x00 })
            },
            ...
            { "selectMenu", new HookEntry(
                 ...
                 new byte[24] { 0x48, 0x89, 0x5C, 0x24, 0x08, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xF9, 0xE8, 0xDE, 0x96,
                                0xCE, 0xFF, 0x48, 0x8D, 0x97, 0x68, 0x04, 0x00 })
            },
